...
export function MobileBar() {
  ...
  return (
    <nav
      aria-label="Mobile"
      className="flex shrink-0 items-stretch border-t border-border bg-canvas-2 md:hidden"
    >
      ...
      <button
        ...
        className="flex flex-1 flex-col items-center gap-0.5 py-2 text-[0.625rem] text-muted-foreground"
      >
