...
export const PRIMARY_NAV: NavItem[] = [
  {
    ...
    description: "Where did we leave off",
  },
  {
    id: "executive",
    label: "Executive",
    to: "/executive",
    icon: Building2,
    description: "Bell Cap Group oversight",
  },
  {
    id: "organizations",
    label: "Organizations",
    to: "/organizations",
    icon: Boxes,
    description: "Legal entities and units",
  },
  {
    id: "products",
    label: "Products",
  ...
  },
  {
    ...
    to: "/engineering",
    icon: GitBranch,
    description: "Stage gates and checkpoints",
  },
  {
    id: "infrastructure",
    ...
    to: "/infrastructure",
    icon: Cpu,
    description: "Asset registry and topology",
  },
  {
    id: "repositories",
    label: "Repositories",
  ...
  },
  {
    ...
    to: "/roadmaps",
    icon: MapIcon,
    description: "Horizons and lanes",
  },
  {
    id: "releases",
    label: "Releases",
  ...
  },
  {
    ...
    to: "/documents",
    icon: FileStack,
    description: "Institutional records",
  },
  ...
  },
  {
    ...
    to: "/activity",
    icon: Activity,
    description: "Institutional ledger",
  },
];
...
export const WORKSPACE_CONTEXT_NAV: Record<string, NavItem[]> = {
  ...
  executive: [
    {
      ...
      to: "/organizations",
      icon: Building2,
      description: "Ownership hierarchy",
    },
    {
      id: "exec-docs",
  ...
  technologies: [
    ...
    },
    {
      ...
      icon: FileStack,
      description: "Snapshot register",
    },
  ],
  "driving-academy": [
    {
      id: "da-docs",
      label: "Curriculum Records",
      to: "/documents",
      icon: FileStack,
      description: "Curriculum and course maps",
    },
  ],
  infrastructure: [
    {
      ...
      icon: Cpu,
      description: "Interactive topology",
    },
    {
      id: "infra-assets",
  ...
  institutional: [
    ...
    },
    {
      ...
      to: "/activity",
      icon: Activity,
      description: "Append-oriented ledger",
    },
  ],
};
